...
#define GENERATED_ATTRIBUTES { \
  ...
  { 0x0000, ZAP_TYPE(DEVICE_TYPE), ERROR: Device, invalid size, device_type, 0, { (uint8_t *) 0 } }, /* Descriptor (server): Device */  \
  { 0x0001, ZAP_TYPE(CLUSTER_ID), 2, 0, { (uint8_t *) 0x0000 } }, /* Descriptor (server): Server */  \
  { 0x0002, ZAP_TYPE(CLUSTER_ID), 2, 0, { (uint8_t *) 0x0000 } }, /* Descriptor (server): Client */  \
  { 0xFFFD, ZAP_TYPE(INT16U), 2, 0, { (uint8_t *) 0x0001 } }, /* Descriptor (server): cluster revision */  \
  { 0x0003, ZAP_TYPE(ENDPOINT_ID), 1, 0, { (uint8_t *) 0x0000 } }, /* Descriptor (server): Parts */  \
}
...
#define GENERATED_CLUSTERS { \
  ...
  { 0xF002, ZAP_ATTRIBUTE_INDEX(3), 5, 0ERROR: Device, invalid size, device_type2221, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Descriptor (server) */ \
}
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 2, 40ERROR: Device, invalid size, device_type2221 }, \
}
...
#define ATTRIBUTE_MAX_SIZE (4ERROR: Device, invalid size, device_type2221)
...
#define FIXED_PROFILE_IDS { 0xABCD }
